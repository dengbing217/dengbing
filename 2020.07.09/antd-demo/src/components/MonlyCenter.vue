<template>
  <div class="UserCenter">
    ...
    >
      ...
      <a-input v-model="adduname" placeholder="请输入工作组编号"></a-input>
      <a-input v-model="addname" placeholder="请输入工作组名称"></a-input>
      <a-input v-model="addpost" placeholder="请输入有效标识"></a-input>
    </a-modal>
  </div>
</template>
<script>
...
export default {
  ...
  mounted() {
    axios.post("MoneyList.com").then(Userlist => {
      //这里post和get都行
